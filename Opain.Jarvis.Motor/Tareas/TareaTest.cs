    ...
    public static class TareaTest
    {
        public static async Task Ejecutar(System.Threading.CancellationToken cancellationToken)
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                //Conectarse a oracle con metodo

                #region "Performance -> Si Personalizar"
                Performance.Contadores.Aumentar(Performance.Tipo.TareaContadorTest);
                #endregion
